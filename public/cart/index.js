  ...
  let content = `
                        ...
                        <div class="flex flex-1 px-5 py-4">
                            <div class="info">  
                                ...
                                <div class="mt-2 text-[#757575] text-[16px]">${
                                  item.typeProduct
                                }</div>
                            ...
                            <div class="price ml-auto">
                                <p class="text-black text-[20px ]">${numToPrice(
                                  item.price
                                )}đ</p>
                            </div>
                        </div>
...
function quantity(item) {
  ...
  for (var i = 1; i < 11; i++) {
    ...
    else temp += `<option id='${i}' value="${i}">${i}</option>`;
  }
  return temp;
}
...
function checkOut() {
  ...
  fetch("https://nike-sever-vtcoder.glitch.me/cart/create", {
    method: "POST",
    headers: {
      Authorization: token,
